...
# train_dataset1 = load_from_disk("./data/dataset/dataset_train_Books")
# train_dataset2 = load_from_disk("./data/dataset/dataset_train_CDs_and_Vinyl")
# train_dataset3 = load_from_disk("./data/dataset/dataset_train_Movies_and_TV")
...
# val_dataset1 = load_from_disk("./data/dataset/dataset_test_Books")
# val_dataset2 = load_from_disk("./data/dataset/dataset_test_CDs_and_Vinyl")
# val_dataset3 = load_from_disk("./data/dataset/dataset_test_Movies_and_TV")
...
meta_dataset1 = load_from_disk("./data/dataset/dataset_meta_Books")
meta_dataset2 = load_from_disk("./data/dataset/dataset_meta_CDs_and_Vinyl")
meta_dataset3 = load_from_disk("./data/dataset/dataset_meta_Movies_and_TV")
...
for i, category in enumerate(categories):
    test_main_dataset = load_from_disk(f"./data/dataset/dataset_test_{category}")
